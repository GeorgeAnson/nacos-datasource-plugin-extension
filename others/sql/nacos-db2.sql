...
(
    ...
    MD5                VARCHAR(32),
    GMT_CREATE         TIMESTAMP(6)  default CURRENT TIMESTAMP not null,
    GMT_MODIFIED       TIMESTAMP(6)                            not null,
    SRC_USER           CLOB(1048576),
    SRC_IP             VARCHAR(50),
    ...
    EFFECT             VARCHAR(64),
    TYPE               VARCHAR(64),
    C_SCHEMA           CLOB(1048576),
    ENCRYPTED_DATA_KEY CLOB(1048576) default ''                not null,
...
(
    ...
    CONTENT      CLOB(1048576),
    GMT_MODIFIED TIMESTAMP(6) default CURRENT TIMESTAMP not null,
    APP_NAME     VARCHAR(128),
    TENANT_ID    VARCHAR(128) default ''                not null,
...
comment on column CONFIG_INFO_AGGR.APP_NAME is 'app name';
...
(
    ...
    CONTENT            CLOB(1048576) default ''                not null,
...
comment on column CONFIG_INFO_TAG.BETA_IPS is 'betaIps';
...
comment on table HIS_CONFIG_INFO is 'config_info';
...
comment on column TENANT_CAPACITY.MAX_AGGR_SIZE is '单个聚合数据的子配置大小上限';
